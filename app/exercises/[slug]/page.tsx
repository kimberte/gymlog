...
const ILLUSTRATIONS: Record<string, string> = {
  "barbell-bench-press": "/exercises/illustrations/barbell-bench-press.svg",
  "barbell-back-squat": "/exercises/illustrations/barbell-back-squat.svg",
  deadlift: "/exercises/illustrations/deadlift.svg",
  "lat-pulldown": "/exercises/illustrations/lat-pulldown.svg",
  "dumbbell-curl": "/exercises/illustrations/dumbbell-curl.svg",
};
  ...
  return <main className="exercise-detail-page">
    ...
    <article className="exercise-detail">
      ...
      <div className="exercise-visual">
        {illustration ? <img src={illustration} alt={`${exercise.name} exercise illustration`} /> : <div className="exercise-visual-placeholder">Original Gym Log exercise illustration coming soon.<br/>For now, this exercise includes accurate, original written guidance.</div>}
      </div>
